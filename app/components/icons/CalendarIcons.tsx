/**
 * Calendar and event-related icons
 * Includes calendar, location, time, document, and communication icons
 */
...
export const EmailIcon: React.FC<IconProps> = ({ className = "", size = 24, ...props }) => (
  <svg
    className={className}
    width={size}
    height={size}
